...
")
 ...
 '(org-capture-templates (quote (("c" "Clocked entry" entry (file+datetree "") "* %a %?\\n%U" :clock-in t :clock-keep t) ("j" "Datetree entry" entry (file+datetree "") "* %a %?\\n%U") ("h" "habit" entry (file+olp "" "Agenda" "Habits" "Other") "* HABIT %?\\n:PROPERTIES:\\n:STYLE: habit\\n:END:") ("s" "Scratch" entry (file+olp "" "Scratch") "* %a %?\\n%U") ("w" "To Watch" entry (file+olp "org-default-notes-file" "Agenda" "Projects" "Consumption" "Videos") "* TODO %?\\n%U") ("k" "Book to read" entry (file+olp "" "Agenda" "Projects" "Consumption" "Books") "* SOMEDAY %?\\n%U") ("d" "Design Examples" entry (file+olp "" "Reference" "Health" "Mental" "Learning" "Writing" "Publishing/Typesetting" "Web" "Examples") "* SOMEDAY %?\\n%U") ("t" "Task" entry (file+olp "" "Agenda" "Tasks" "Todo") "* TODO %?\\n%U") ("b" "Bookmarks to file" entry (file+olp "" "Agenda" "Tasks" "Filing") "* FILE %a %?\\n%U"))))

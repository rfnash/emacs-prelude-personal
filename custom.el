...
(custom-set-faces
 ...
 '(term ((t (:inherit default :background "#002b36"))) t)
 '(term-bold ((t (:inverse-video t :weight bold))) t)
 '(term-color-black ((t (:background "#002b36" :foreground "#073642"))) t)
 '(term-color-blue ((t (:background "#002b36" :foreground "#268bd2"))) t)
 '(term-color-cyan ((t (:background "#002b36" :foreground "#2aa198"))) t)
 '(term-color-green ((t (:background "#002b36" :foreground "#859900"))) t)
 '(term-color-magenta ((t (:background "black" :foreground "#d33682"))) t)
 '(term-color-red ((t (:background "#002b36" :foreground "#dc322f"))) t)
 '(term-color-white ((t (:background "#002b36" :foreground "#eee8d5"))) t)
 '(term-color-yellow ((t (:background "#002b36" :foreground "#b58900"))) t))
